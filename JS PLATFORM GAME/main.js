...
},{"./actors":2,"./levels":4}],2:[function(require,module,exports){
const {
    elt
} = require('./DOM');
...
},{"./actors":2}],4:[function(require,module,exports){
const {
    levelChars
} = require('./game');
...
},{"./actors":2,"./game":3}],5:[function(require,module,exports){
const {
    Level,
    State
} = require('./levels');
